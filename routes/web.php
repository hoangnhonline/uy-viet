...
Route::group(['prefix' => 'get-controller'], function()
{ 
    Route::post('/login', ['as' => 'webservice.login', 'uses' => 'GetController@login']);
    Route::post('/custom-search', ['as' => 'webservice.search', 'uses' => 'GetController@search']);
    Route::get('/province', ['as' => 'webservice.province', 'uses' => 'GetController@province']);
    Route::get('/shoptype', ['as' => 'webservice.shoptype', 'uses' => 'GetController@shoptype']);
    
    Route::get('/district/{province_id?}', ['as' => 'webservice.district', 'uses' => 'GetController@district']);
    Route::get('/ward/{district_id?}', ['as' => 'webservice.ward', 'uses' => 'GetController@ward']);
    Route::post('/add-point', ['as' => 'webservice.addpoint', 'uses' => 'GetController@addPoint']);
