...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      @endif
      <a href="{{ route('shop-tiem-nang.create') }}" class="btn btn-info btn-sm" style="margin-bottom:5px">Tạo mới</a>
      <div class="box">
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td style="white-space:nowrap">
                  <a href="{{ route( 'shop-tiem-nang.edit', [ 'id' => $item->id ]) }}" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span></a>                                  
                  @if($item->shops()->count() == 0)
                  <a onclick="return callDelete('{{ $item->type }}','{{ route( 'shop-tiem-nang.destroy', [ 'id' => $item->id ]) }}');" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>                 
                  @endif
                </td>
              </tr> 
              @endforeach
