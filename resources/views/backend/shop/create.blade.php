...
<div class="content-wrapper">
   ...
   <section class="content">
      ...
      <form role="form" method="POST" action="{{ route('shop.store') }}" id="formData">         
         ...
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <div class="box box-primary">
                  ...
                  <div class="box-body">
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name="company_id" id="company_id">
                           ...
                           <option value="{{ $com->id }}" {{ $com->id == old('company_id') ? "selected" : "" }}>{{ $com->company_name }}</option>
                           @endforeach
                        </select>
                     </div>
                     <!-- text input -->
                     <div class="form-group col-md-6">
                        ...
                        <select class="form-control" name=" type_id" id=" type_id">
                           ...
                           <option value="{{ $com->id }}" {{ $com->id == old('type_id') ? "selected" : "" }}>{{ $com->type }}</option>
                           @endforeach
                        </select>
                     </div>
                     <!-- text input -->
                  ...
                  <?php                      
                     $latt = old('latt', '10.7860332');
                     $longt = old('longt', '106.6950147');
                     ?>
                  ...
                  <div class="box-body">
                     @foreach($conditionList as $condition)
                      <div class="form-group col-md-6">
                        ...
                        <option value="{{ $data->id }}" {{ old('cond[$key]') == $data->id ? "selected" : "" }}>{{ $data->type }} </option>                  
                        @endforeach
                        </select>
                     </div>                     
                      @endforeach   
