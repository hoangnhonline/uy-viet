...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('shop.index', ['estate_type_id' => $detail->estate_type_id, 'cate_id' => $detail->cate_id]) }}" style="margin-bottom:5px">Quay lại</a>
    ...
    <form role="form" method="POST" action="{{ route('shop.update') }}" id="dataForm">
    <div class="row">
      <!-- left column -->
...
<input type="hidden" id="editor" value="description">
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('shop.index', ['estate_type_id' => $detail->estate_type_id])}}">Hủy</a>
            </div>
