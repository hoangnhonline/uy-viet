...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('shop-size.index') }}" style="margin-bottom:5px">Quay lại</a>   
    <div class="row">
      <!-- left column -->
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="{{ route('shop-size.update') }}">
            {!! csrf_field() !!}
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('shop-size.index')}}">Hủy</a>
            </div>
