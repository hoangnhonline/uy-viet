...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('loai-sp.index') }}?type={{ $type }}">Danh mục</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('loai-sp.index') }}?type={{ $type }}" style="margin-bottom:5px">Quay lại</a>
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('loai-sp.index')}}?type={{ $type }}">Hủy</a>
            </div>
