    ...
    <div class="col-md-12">
      ...
      <div class="box">
        ...
        <form method="post" action={{ route('save-col-order')}} >
            {{ csrf_field() }}
            <input type="hidden" name="table" value="shop_quy_mo1480440358">
            <input type="hidden" name="return_url" value="{{ url()->current() }}">
            @if($items->count() > 0)
            <button type="submit" class="btn btn-warning btn-sm">Save thứ tự</button>
            @endif
          <table class="table table-bordered" id="table-list-data" data-table="shop_quy_mo1480440358" style="margin-top:5px">
            <tr>
              <th style="width: 1%">#</th>
