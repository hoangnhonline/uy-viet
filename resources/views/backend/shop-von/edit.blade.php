...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="{{ route('shop-von.index') }}" style="margin-bottom:5px">Quay lại</a>   
    <div class="row">
      <!-- left column -->
      ...
      <div class="col-md-7">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" method="POST" action="{{ route('shop-von.update') }}">
            {!! csrf_field() !!}
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label>Tên loại vốn<span class="red-star">*</span></label>
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="{{ route('shop-von.index')}}">Hủy</a>
            </div>
