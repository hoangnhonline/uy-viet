        ...
        <ul id="menu-content" class="menu-content collapse out">
            ...
            <ul id="check-list-box-level" class="list-group checked-list-box sub-menu collapse">
                <?php $__currentLoopData = $levels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <li class="list-group-item" value="<?php echo e($level->id); ?>"><?php echo e($level->type); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
            </ul>
            ...
            <ul class="sub-menu collapse list-group checked-list-box" id="check-list-box-tiemnang">
                <?php $__currentLoopData = $tiemnang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tiemnang_item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <li class="list-group-item" value="<?php echo e($tiemnang_item->id); ?>"><?php echo e($tiemnang_item->type); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
            </ul>
            ...
            <ul class="sub-menu collapse list-group checked-list-box" id="check-list-box-quymo">
                <?php $__currentLoopData = $quymo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quymo_item): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <li class="list-group-item" value="<?php echo e($quymo_item->id); ?>"><?php echo e($quymo_item->type); ?></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
            </ul>
        </ul>
    </div>
